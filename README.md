...
sudo docker run --rm -v "./cache/niconico_user_icons:/code/live_inbox_updater/cache/niconico_user_icons" --env-file .env docker.aoirint.com/aoirint/live_inbox_updater update
```
