...
from live_inbox_updater.live_inbox_hasura_api.niconico_live_program_api import (
    NiconicoLiveProgramUpsertObject,
    upsert_niconico_live_programs,
)
from live_inbox_updater.live_inbox_hasura_api.niconico_user_api import (
...
def main() -> None:
    ...
    for user_index in range(0, len(niconico_users), 8):
        # TODO:
        pass
